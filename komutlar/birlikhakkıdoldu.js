...
exports.run = async (client, message, args) => {
  ...
  const erkekrol = await jkood.BirlikHakkıDoldu
  if(!erkekrol) return message.reply(`Birlik Hakkı Rolü Ayarlanmamış!`)
    ...
    setTimeout(function(){user.roles.add(jkood.BirlikHakkıDoldu)},3000)
    setTimeout(function(){user.roles.remove(jkood.ÜçüncüBirlikHakkı)},4000)
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["brlkhkkdoldu"],
  permLevel: 0
};
exports.help = {
  name: "brlkhkkdoldu",
  description: "",
  usage: "brlkhkkdoldu @etiket"
};
