...
exports.run = async (client, message, args) => {
  ...
  const erkekrol = await jkood.ÜçüncüBirlikHakkı
  if(!erkekrol) return message.reply(`Birlik Hakkı Rolü Ayarlanmamış!`)
    ...
    setTimeout(function(){user.roles.add(jkood.ÜçüncüBirlikHakkı)},3000)
    setTimeout(function(){user.roles.remove(jkood.İkinciBirlikHakkı)},4000)
